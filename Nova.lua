...
local TheNova = io.open("TheNova", 'w')
TheNova:write([[
cd $(cd $(dirname $0); pwd)
while(true) do
sudo lua5.3 Nova.lua
done
]])
TheNova:close()
...
cd $(cd $(dirname $0); pwd)
while(true) do
screen -S TheNova -X kill
screen -S TheNova ./TheNova
done
]])
Run:close()
Redis:del(SshId.."Info:Redis:User:ID");Redis:del(SshId.."Info:Redis:User");Redis:del(SshId.."Info:Redis:Token:User");Redis:del(SshId.."Info:Redis:Token")
os.execute('chmod +x TheNova;chmod +x Run;./Run')
end
...
TheNova = Token:match("(%d+)")
os.execute('sudo rm -fr .CallBack-Bot/'..TheNova)
LuaTele = luatele.set_config{api_id=2692371,api_hash='fe85fff033dfe0f328aeb02b4f784930',session_name=TheNova,token=Token}
function var(value)  
...
ControllerAll = false
local ListSudos ={Sudo_Id,5053005126,2118374481}  
...
Status = 0
DevelopersQ = Redis:sismember(TheNova.."Nova:DevelopersQ:Groups",UserId) 
if UserId == 5053005126 then
Status = true
elseif UserId == 2118374481 then
Status = true
...
Status = 0
Developers = Redis:sismember(TheNova.."Nova:Developers:Groups",UserId) 
DevelopersQ = Redis:sismember(TheNova.."Nova:DevelopersQ:Groups",UserId) 
TheBasics = Redis:sismember(TheNova.."Nova:TheBasics:Group"..ChatId,UserId) 
Originators = Redis:sismember(TheNova.."Nova:Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(TheNova.."Nova:Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(TheNova.."Nova:Addictive:Group"..ChatId,UserId)
Distinguished = Redis:sismember(TheNova.."Nova:Distinguished:Group"..ChatId,UserId)
StatusMember = LuaTele.getChatMember(ChatId,UserId).status.luatele
if UserId == 5036380339 then
Status = 'مبرمج السورس'
elseif UserId == 2024383052 then
Status = 'مبرمج السورس'
elseif UserId == 5049866330 then
Status = 'مبرمج السورس'
elseif UserId == 5147428159 then
Status = 'مبرمج السورس'
elseif UserId == Sudo_Id then  
...
Status = Redis:get(TheNova.."Nova:Developer:Bot:Reply"..ChatId) or 'المطور'
elseif TheBasics then
Status = Redis:get(TheNova.."Nova:President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Originators then
Status = Redis:get(TheNova.."Nova:Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Managers then
Status = Redis:get(TheNova.."Nova:Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(TheNova.."Nova:Admin:Group:Reply"..ChatId) or 'الادمن'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك المجموعه'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن المجموعه'
elseif Distinguished then
Status = Redis:get(TheNova.."Nova:Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(TheNova.."Nova:Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(TheNova.."Nova:lockpin"..ChatId) then    
lock_pin = "✔️"
else 
lock_pin = "❌"    
end
if Redis:get(TheNova.."Nova:Lock:tagservr"..ChatId) then    
lock_tagservr = "✔️"
else 
lock_tagservr = "❌"
end
if Redis:get(TheNova.."Nova:Lock:text"..ChatId) then    
lock_text = "✔️"
else 
lock_text = "❌ "    
end
if Redis:get(TheNova.."Nova:Lock:AddMempar"..ChatId) == "kick" then
lock_add = "✔️"
else 
lock_add = "❌ "    
end    
if Redis:get(TheNova.."Nova:Lock:Join"..ChatId) == "kick" then
lock_join = "✔️"
else 
lock_join = "❌ "    
end    
if Redis:get(TheNova.."Nova:Lock:edit"..ChatId) then    
lock_edit = "✔️"
else 
lock_edit = "❌ "    
end
if Redis:get(TheNova.."Nova:Chek:Welcome"..ChatId) then
welcome = "✔️"
else 
welcome = "❌ "    
end
if Redis:hget(TheNova.."Nova:Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(TheNova.."Nova:Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(TheNova.."Nova:Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(TheNova.."Nova:Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "✔️"
else     
flood = "❌ "     
end
if Redis:get(TheNova.."Nova:Lock:Photo"..ChatId) == "del" then
lock_photo = "✔️" 
elseif Redis:get(TheNova.."Nova:Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(TheNova.."Nova:Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(TheNova.."Nova:Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "❌ "   
end    
if Redis:get(TheNova.."Nova:Lock:Contact"..ChatId) == "del" then
lock_phon = "✔️" 
elseif Redis:get(TheNova.."Nova:Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(TheNova.."Nova:Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(TheNova.."Nova:Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "❌ "    
end    
if Redis:get(TheNova.."Nova:Lock:Link"..ChatId) == "del" then
lock_links = "✔️"
elseif Redis:get(TheNova.."Nova:Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(TheNova.."Nova:Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(TheNova.."Nova:Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "❌ "    
end
if Redis:get(TheNova.."Nova:Lock:Cmd"..ChatId) == "del" then
lock_cmds = "✔️"
elseif Redis:get(TheNova.."Nova:Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(TheNova.."Nova:Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(TheNova.."Nova:Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "❌ "    
end
if Redis:get(TheNova.."Nova:Lock:User:Name"..ChatId) == "del" then
lock_user = "✔️"
elseif Redis:get(TheNova.."Nova:Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(TheNova.."Nova:Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(TheNova.."Nova:Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "❌ "    
end
if Redis:get(TheNova.."Nova:Lock:hashtak"..ChatId) == "del" then
lock_hash = "✔️"
elseif Redis:get(TheNova.."Nova:Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(TheNova.."Nova:Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(TheNova.."Nova:Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "❌ "    
end
if Redis:get(TheNova.."Nova:Lock:vico"..ChatId) == "del" then
lock_muse = "✔️"
elseif Redis:get(TheNova.."Nova:Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(TheNova.."Nova:Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(TheNova.."Nova:Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "❌ "    
end 
if Redis:get(TheNova.."Nova:Lock:Video"..ChatId) == "del" then
lock_ved = "✔️"
elseif Redis:get(TheNova.."Nova:Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(TheNova.."Nova:Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(TheNova.."Nova:Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "❌ "    
end
if Redis:get(TheNova.."Nova:Lock:Animation"..ChatId) == "del" then
lock_gif = "✔️"
elseif Redis:get(TheNova.."Nova:Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(TheNova.."Nova:Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(TheNova.."Nova:Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "❌ "    
end
if Redis:get(TheNova.."Nova:Lock:Sticker"..ChatId) == "del" then
lock_ste = "✔️"
elseif Redis:get(TheNova.."Nova:Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(TheNova.."Nova:Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(TheNova.."Nova:Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "❌ "    
end
if Redis:get(TheNova.."Nova:Lock:geam"..ChatId) == "del" then
lock_geam = "✔️"
elseif Redis:get(TheNova.."Nova:Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(TheNova.."Nova:Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(TheNova.."Nova:Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "❌ "    
end    
...
if Redis:get(TheNova.."Nova:Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "✔️"
elseif Redis:get(TheNova.."Nova:Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(TheNova.."Nova:Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(TheNova.."Nova:Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "❌ "
end
if Redis:get(TheNova.."Nova:Lock:forward"..ChatId) == "del" then
lock_fwd = "✔️"
elseif Redis:get(TheNova.."Nova:Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(TheNova.."Nova:Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(TheNova.."Nova:Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "❌ "    
end    
if Redis:get(TheNova.."Nova:Lock:Document"..ChatId) == "del" then
lock_file = "✔️"
elseif Redis:get(TheNova.."Nova:Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(TheNova.."Nova:Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(TheNova.."Nova:Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "❌ "    
end    
if Redis:get(TheNova.."Nova:Lock:Unsupported"..ChatId) == "del" then
lock_self = "✔️"
elseif Redis:get(TheNova.."Nova:Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(TheNova.."Nova:Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(TheNova.."Nova:Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "❌ "    
end
if Redis:get(TheNova.."Nova:Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "✔️"
elseif Redis:get(TheNova.."Nova:Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(TheNova.."Nova:Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "❌ "    
end
if Redis:get(TheNova.."Nova:Lock:Markdaun"..ChatId) == "del" then
lock_mark = "✔️"
elseif Redis:get(TheNova.."Nova:Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(TheNova.."Nova:Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(TheNova.."Nova:Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "❌ "    
end
if Redis:get(TheNova.."Nova:Lock:Spam"..ChatId) == "del" then    
lock_spam = "✔️"
elseif Redis:get(TheNova.."Nova:Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(TheNova.."Nova:Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(TheNova.."Nova:Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "❌ "    
end        
...
return{
BanAll = Redis:sismember(TheNova.."Nova:BanAll:Groups",UserId) ,
BanGroup = Redis:sismember(TheNova.."Nova:BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(TheNova.."Nova:SilentGroup:Group"..ChatId,UserId)
}
end
...
return {
Lock     = '[‹SOURCE JACK ›](https://t.me/Nova)\n*— — — — — — — — —\n◍ بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n◍ خاصيه المسح *',
unLock   = '[‹SOURCE JACK ›](https://t.me/Nova)\n*— — — — — — — — —\n◍ بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[‹SOURCE JACK ›](https://t.me/Nova)\n*— — — — — — — — —\n◍ بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n◍ خاصيه الكتم *',
lockKid  = '[‹SOURCE JACK ›](https://t.me/Nova)\n*— — — — — — — — —\n◍ بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n◍ خاصيه التقييد *',
lockKick = '[‹SOURCE JACK ›](https://t.me/Nova)\n*— — — — — — — — —\n◍ بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n◍ خاصيه الطرد *',
Reply    = '[‹SOURCE JACK ›](https://t.me/Nova)\n*— — — — — — — — —\n◍ المستخدم ← *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,TheNova).status
if GetMemberStatus.can_change_info then
...
JoinChannel = true
local Channel = Redis:get(TheNova..'Nova:Channel:Join')
if Channel then
...
if tonumber(msg.sender.user_id) == tonumber(TheNova) then
...
elseif tonumber(msg.sender.user_id) == 2024383052 then
msg.Name_Controller = 'مبرمج السورس '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 5049866330 then
msg.Name_Controller = 'مبرمج السورس '
elseif tonumber(msg.sender.user_id) == 5147428159 then
msg.Name_Controller = 'مبرمج السورس '
msg.The_Controller = 1
msg.The_Controller = 1
...
elseif Redis:sismember(TheNova.."Nova:DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(TheNova.."Nova:Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(TheNova.."Nova:Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(TheNova.."Nova:TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(TheNova.."Nova:President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي ⭐'
elseif Redis:sismember(TheNova.."Nova:Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(TheNova.."Nova:Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(TheNova.."Nova:Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(TheNova.."Nova:Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(TheNova.."Nova:Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(TheNova.."Nova:Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(TheNova.."Nova:Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(TheNova.."Nova:Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(TheNova) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(TheNova.."Nova:Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(TheNova.."Nova:Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(TheNova.."Nova:Status:Welcome"..msg_chat_id) then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(TheNova.."Nova:Welcome:Group"..msg_chat_id)
if Welcome then 
if UserInfo.username then
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(TheNova.."Nova:Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(TheNova) then
return false
end
local floods = Redis:hget(TheNova.."Nova:Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(TheNova.."Nova:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(TheNova.."Nova:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(TheNova.."Nova:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(TheNova.."Nova:Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(TheNova.."Nova:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
...
Redis:setex(TheNova.."Nova:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(TheNova.."Nova:Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(TheNova.."Nova:Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
...
sens = 400  
if Redis:get(TheNova.."Nova:Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TheNova.."Nova:Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TheNova.."Nova:Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TheNova.."Nova:Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(TheNova.."Nova:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Distinguished then -- التوجيه
local Fwd_Group = Redis:get(TheNova.."Nova:Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(TheNova.."Nova:Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(TheNova.."Nova:Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(TheNova.."Nova:Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(TheNova.."Nova:lockpin"..msg_chat_id)
...
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(TheNova.."Nova:Lock:Join"..msg.chat_id) == "kick" then
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end
...
Redis:incr(TheNova.."Nova:Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(TheNova.."Nova:Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(TheNova.."Nova:Lock:Bot:kick"..msg_chat_id)
...
Redis:incr(TheNova.."Nova:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
local Contact_Group = Redis:get(TheNova.."Nova:Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(TheNova.."Nova:Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(TheNova.."Nova:Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(TheNova.."Nova:Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(TheNova.."Nova:Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(TheNova.."Nova:Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(TheNova.."Nova:Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(TheNova.."Nova:Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(TheNova.."Nova:Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(TheNova.."Nova:Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(TheNova.."Nova:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
local ChatPhoto = LuaTele.setChatPhoto(msg_chat_id,msg.content.photo.sizes[2].photo.remote.id)
if (ChatPhoto.luatele == "error") then
Redis:del(TheNova.."Nova:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(TheNova.."Nova:Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(TheNova.."Nova:Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(TheNova.."Nova:Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(TheNova.."Nova:Lock:Cmd"..msg_chat_id)
...
if (Redis:get(TheNova..'Nova:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(TheNova.."Nova:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(TheNova.."Nova:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(TheNova.."Nova:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(TheNova.."Nova:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(TheNova.."Nova:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(TheNova.."Nova:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(TheNova.."Nova:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(TheNova.."Nova:List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(TheNova..'Nova:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n◍ ارسل تحذير ( "..Filters.." ) عند ارساله","md",true)  
end
end
if text and (Redis:get(TheNova..'Nova:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(TheNova.."Nova:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(TheNova.."Nova:Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(TheNova.."Nova:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(TheNova..'Nova:FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n◍ تم اضافه رد التحذير","md",true)  
end
if text and (Redis:get(TheNova..'Nova:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(TheNova.."Nova:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(TheNova.."Nova:Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(TheNova.."Nova:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(TheNova.."Nova:Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(TheNova.."Nova:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(TheNova.."Nova:Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(TheNova.."Nova:List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(TheNova.."Nova:Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(TheNova..'Nova:FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(TheNova.."Nova:Filter:Group:"..DelFilters..msg_chat_id)
...
if text and Redis:get(TheNova.."Nova:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(TheNova.."Nova:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(TheNova.."Nova:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(TheNova.."Nova:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(TheNova.."Nova:Command:List:Group"..msg_chat_id,text)
...
Redis:del(TheNova.."Nova:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(TheNova.."Nova:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(TheNova.."Nova:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(TheNova.."Nova:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(TheNova.."Nova:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"◍ ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(TheNova.."Nova:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(TheNova.."Nova:Command:Reids:Group:New"..msg_chat_id)
Redis:set(TheNova.."Nova:Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(TheNova.."Nova:Command:List:Group"..msg_chat_id,text)
Redis:del(TheNova.."Nova:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم حفظ الامر باسم ← { "..text..' }',"md",true)
end
if Redis:get(TheNova.."Nova:Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(TheNova.."Nova:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:set(TheNova.."Nova:Group:Link"..msg_chat_id,LinkGroup)
Redis:del(TheNova.."Nova:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"📥︙تم حفظ الرابط بنجاح","md",true)         
end
end 
if Redis:get(TheNova.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(TheNova.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم الغاء حفظ الترحيب","md",true)   
end 
Redis:del(TheNova.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(TheNova.."Nova:Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم حفظ ترحيب المجموعه","md",true)     
end
if Redis:get(TheNova.."Nova:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(TheNova.."Nova:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم الغاء حفظ القوانين","md",true)   
end 
Redis:set(TheNova.."Nova:Group:Rules" .. msg_chat_id,text) 
Redis:del(TheNova.."Nova:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم حفظ قوانين المجموعه","md",true)  
end  
if Redis:get(TheNova.."Nova:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(TheNova.."Nova:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
local test = Redis:get(TheNova.."Nova:Text:Manager"..msg.sender.user_id..":"..msg_chat_id.."")
if Redis:get(TheNova.."Nova:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(TheNova.."Nova:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(TheNova.."Nova:Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(TheNova.."Nova:Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
end   
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheNova.."Nova:Add:Rd:Manager:Text"..test..msg_chat_id, text)  
end  
if msg.content.audio then
Redis:set(TheNova.."Nova:Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(TheNova.."Nova:Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
end
if msg.content.animation then
Redis:set(TheNova.."Nova:Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
end
if msg.content.video_note then
Redis:set(TheNova.."Nova:Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.video then
Redis:set(TheNova.."Nova:Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
end
if msg.content.photo then
...
print(idPhoto)
Redis:set(TheNova.."Nova:Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  
end
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم حفظ رد للمدير بنجاح \n◍ ارسل ( "..test.." ) لرئية الرد","md",true)  
end  
end
if text and text:match("^(.*)$") then
if Redis:get(TheNova.."Nova:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(TheNova.."Nova:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(TheNova.."Nova:Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(TheNova.."Nova:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(TheNova.."Nova:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(TheNova.."Nova:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(TheNova.."Nova:Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(TheNova.."Nova:Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(TheNova.."Nova:Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(TheNova.."Nova:Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(TheNova.."Nova:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(TheNova.."Nova:Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:sadd(TheNova.."Nova:List:Manager"..msg_chat_id.."", text)
...
if text and text:match("^(.*)$") then
if Redis:get(TheNova.."Nova:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(TheNova.."Nova:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(TheNova.."Nova:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(TheNova.."Nova:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(TheNova.."Nova:Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(TheNova.."Nova:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(TheNova.."Nova:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(TheNova.."Nova:List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"◍ تم حذف الرد من ردود المدير ","md",true)  
return false
end
end
if text and Redis:get(TheNova.."Nova:Status:ReplySudo"..msg_chat_id) then
local anemi = Redis:get(TheNova.."Nova:Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(TheNova.."Nova:Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(TheNova.."Nova:Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(TheNova.."Nova:Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(TheNova.."Nova:Add:Rd:Sudo:Photo"..text)
local video = Redis:get(TheNova.."Nova:Add:Rd:Sudo:Video"..text)
local document = Redis:get(TheNova.."Nova:Add:Rd:Sudo:File"..text)
local audio = Redis:get(TheNova.."Nova:Add:Rd:Sudo:Audio"..text)
local video_note = Redis:get(TheNova.."Nova:Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(TheNova..'Nova:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(TheNova..'Nova:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
if text and Redis:get(TheNova.."Nova:Status:Reply"..msg_chat_id) then
local anemi = Redis:get(TheNova.."Nova:Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(TheNova.."Nova:Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(TheNova.."Nova:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(TheNova.."Nova:Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(TheNova.."Nova:Add:Rd:Manager:Photo"..text..msg_chat_id)
local video = Redis:get(TheNova.."Nova:Add:Rd:Manager:Video"..text..msg_chat_id)
local document = Redis:get(TheNova.."Nova:Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(TheNova.."Nova:Add:Rd:Manager:Audio"..text..msg_chat_id)
local video_note = Redis:get(TheNova.."Nova:Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(TheNova..'Nova:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(TheNova.."Nova:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(TheNova.."Nova:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(TheNova.."Nova:Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(TheNova.."Nova:Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(TheNova.."Nova:Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
end   
if msg.content.animation then   
Redis:set(TheNova.."Nova:Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheNova.."Nova:Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content.audio then
Redis:set(TheNova.."Nova:Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(TheNova.."Nova:Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
end
if msg.content.video then
Redis:set(TheNova.."Nova:Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
end
if msg.content.video_note then
Redis:set(TheNova.."Nova:Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
Redis:set(TheNova.."Nova:Add:Rd:Sudo:Photo"..test, idPhoto)  
end
...
if text and text:match("^(.*)$") then
if Redis:get(TheNova.."Nova:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(TheNova.."Nova:Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(TheNova.."Nova:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(TheNova.."Nova:List:Rd:Sudo", text)
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي الرد سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
if text and text:match("^(.*)$") then
if Redis:get(TheNova.."Nova:Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
Redis:del(TheNova..'Nova:'..v..text)
end
Redis:del(TheNova.."Nova:Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(TheNova.."Nova:List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم حذف الرد من ردود المطور","md",true)  
end
end
if Redis:get(TheNova.."Nova:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(TheNova.."Nova:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n◍ تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(TheNova.."Nova:ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(TheNova.."Nova:PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
...
Redis:set(TheNova.."Nova:PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(TheNova.."Nova:PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(TheNova.."Nova:PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(TheNova.."Nova:PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(TheNova.."Nova:PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(TheNova.."Nova:PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(TheNova.."Nova:PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v,0,text,"md",true)
Redis:set(TheNova.."Nova:PinMsegees:"..v,text)
end
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheNova.."Nova:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(TheNova.."Nova:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n◍ تم الغاء الاذاعه خاص","md",true)  
end 
local list = Redis:smembers(TheNova..'Nova:Num:User:Pv')  
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheNova.."Nova:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(TheNova.."Nova:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n◍ تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(TheNova.."Nova:ChekBotAdd") 
if msg.content.video_note then
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheNova.."Nova:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(TheNova.."Nova:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheNova.."Nova:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(TheNova.."Nova:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if text and Redis:get(TheNova..'Nova:GetTexting:DevTheNova'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == 'الغاء الامر ⌔' then 
Redis:del(TheNova..'Nova:GetTexting:DevTheNova'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'◍ تم الغاء حفظ كليشة المطور')
end
Redis:set(TheNova..'Nova:Texting:DevTheNova',text)
Redis:del(TheNova..'Nova:GetTexting:DevTheNova'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'◍ تم حفظ كليشة المطور')
end
if Redis:get(TheNova.."Nova:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n◍ تم الغاء امر تعين الايدي","md",true)  
Redis:del(TheNova.."Nova:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(TheNova.."Nova:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(TheNova.."Nova:Set:Id:Group"..msg.chat_id,text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'◍ تم تعين الايدي الجديد',"md",true)  
end
if Redis:get(TheNova.."Nova:Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(TheNova.."Nova:Change:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n◍ تم الغاء امر تغير اسم البوت","md",true)  
end 
Redis:del(TheNova.."Nova:Change:Name:Bot"..msg.sender.user_id) 
Redis:set(TheNova.."Nova:Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "◍  تم تغير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(TheNova.."Nova:Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(TheNova.."Nova:Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n◍ تم الغاء امر تغير كليشه start","md",true)  
end 
Redis:del(TheNova.."Nova:Change:Start:Bot"..msg.sender.user_id) 
Redis:set(TheNova.."Nova:Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "◍  تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(TheNova.."Nova:Game:Smile"..msg.chat_id) then
if text == Redis:get(TheNova.."Nova:Game:Smile"..msg.chat_id) then
Redis:incrby(TheNova.."Nova:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheNova.."Nova:Game:Smile"..msg.chat_id)
...
if Redis:get(TheNova.."Nova:Game:Monotonous"..msg.chat_id) then
if text == Redis:get(TheNova.."Nova:Game:Monotonous"..msg.chat_id) then
Redis:del(TheNova.."Nova:Game:Monotonous"..msg.chat_id)
Redis:incrby(TheNova.."Nova:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(TheNova.."Nova:Game:Riddles"..msg.chat_id) then
if text == Redis:get(TheNova.."Nova:Game:Riddles"..msg.chat_id) then
Redis:incrby(TheNova.."Nova:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheNova.."Nova:Game:Riddles"..msg.chat_id)
...
if Redis:get(TheNova.."Nova:Game:Meaningof"..msg.chat_id) then
if text == Redis:get(TheNova.."Nova:Game:Meaningof"..msg.chat_id) then
Redis:incrby(TheNova.."Nova:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheNova.."Nova:Game:Meaningof"..msg.chat_id)
...
if Redis:get(TheNova.."Nova:Game:Reflection"..msg.chat_id) then
if text == Redis:get(TheNova.."Nova:Game:Reflection"..msg.chat_id) then
Redis:incrby(TheNova.."Nova:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheNova.."Nova:Game:Reflection"..msg.chat_id)
...
if Redis:get(TheNova.."Nova:Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id,"◍ عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(TheNova.."Nova:Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(TheNova.."Nova:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(TheNova.."Nova:Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(TheNova.."Nova:Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id,"◍ مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(TheNova.."Nova:SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(TheNova.."Nova:SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(TheNova.."Nova:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(TheNova.."Nova:Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(TheNova.."Nova:Game:Difference"..msg.chat_id) then
if text == Redis:get(TheNova.."Nova:Game:Difference"..msg.chat_id) then 
Redis:del(TheNova.."Nova:Game:Difference"..msg.chat_id)
Redis:incrby(TheNova.."Nova:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(TheNova.."Nova:Game:Example"..msg.chat_id) then
if text == Redis:get(TheNova.."Nova:Game:Example"..msg.chat_id) then 
Redis:del(TheNova.."Nova:Game:Example"..msg.chat_id)
Redis:incrby(TheNova.."Nova:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(TheNova..'Nova:Channel:Join')}, },}}
...
if tonumber(TheNova) ~= tonumber(FilesJson.BotId) then
return LuaTele.sendText(msg_chat_id,msg_id,'◍ عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
Y = Y + 1
Redis:sadd(TheNova..'Nova:Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(TheNova.."Nova:ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(TheNova.."Nova:TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(TheNova.."Nova:Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(TheNova.."Nova:Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(TheNova.."Nova:Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(TheNova.."Nova:Distinguished:Group"..GroupId,v)
end
end 
end
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(TheNova) then 
return LuaTele.sendText(msg_chat_id,msg_id,'◍ عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(TheNova.."Nova:ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(TheNova.."Nova:Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(TheNova.."Nova:Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(TheNova.."Nova:Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(TheNova.."Nova:TheBasics:Group"..idg,idASAS)
end;end
end
...
if (Redis:get(TheNova..'Nova:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text == 'الغاء' or text == 'الغاء الامر ⌔' then 
Redis:del(TheNova..'Nova:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id)
...
local StatusMember = LuaTele.getChatMember(UserId_Info.id,TheNova).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,"\n◍ البوت عضو في القناة يرجى رفع البوت ادمن واعادة وضع الاشتراك ","md",true)  
end
Redis:set(TheNova..'Nova:Channel:Join',ChannelUser) 
...
Redis:set(TheNova..'Nova:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(TheNova..'Nova:Channel:Join')
...
--download('https://raw.githubusercontent.com/gackmm/shyco/master/Nova.lua','Nova.lua')
...
local Groups = Redis:smembers(TheNova..'Nova:ChekBotAdd')  
local UsersBot = Redis:smembers(TheNova..'Nova:Num:User:Pv')  
local Get_Json = '{"BotId": '..TheNova..','  
if #UsersBot ~= 0 then 
...
local President = Redis:smembers(TheNova.."Nova:TheBasics:Group"..v)
local Constructor = Redis:smembers(TheNova.."Nova:Originators:Group"..v)
local Manager = Redis:smembers(TheNova.."Nova:Managers:Group"..v)
local Admin = Redis:smembers(TheNova.."Nova:Addictive:Group"..v)
local Vips = Redis:smembers(TheNova.."Nova:Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
listrep = Redis:smembers(TheNova.."Nova:List:Manager"..ide.."")
if k == 1 then
...
if Redis:get(TheNova.."Nova:Add:Rd:Manager:Gif"..v..ide) then
db = "gif@"..Redis:get(TheNova.."Nova:Add:Rd:Manager:Gif"..v..ide)
elseif Redis:get(TheNova.."Nova:Add:Rd:Manager:Vico"..v..ide) then
db = "Vico@"..Redis:get(TheNova.."Nova:Add:Rd:Manager:Vico"..v..ide)
elseif Redis:get(TheNova.."Nova:Add:Rd:Manager:Stekrs"..v..ide) then
db = "Stekrs@"..Redis:get(TheNova.."Nova:Add:Rd:Manager:Stekrs"..v..ide)
elseif Redis:get(TheNova.."Nova:Add:Rd:Manager:Text"..v..ide) then
db = "Text@"..Redis:get(TheNova.."Nova:Add:Rd:Manager:Text"..v..ide)
db = string.gsub(db,'"','')
db = string.gsub(db,"'",'')
db = string.gsub(db,'*','')
db = string.gsub(db,'`','')
...
db = string.gsub(db,'}','')
db = string.gsub(db,'\n',' ')
elseif Redis:get(TheNova.."Nova:Add:Rd:Manager:Photo"..v..ide) then
db = "Photo@"..Redis:get(TheNova.."Nova:Add:Rd:Manager:Photo"..v..ide) 
elseif Redis:get(TheNova.."Nova:Add:Rd:Manager:Video"..v..ide) then
db = "Video@"..Redis:get(TheNova.."Nova:Add:Rd:Manager:Video"..v..ide)
elseif Redis:get(TheNova.."Nova:Add:Rd:Manager:File"..v..ide) then
db = "File@"..Redis:get(TheNova.."Nova:Add:Rd:Manager:File"..v..ide)
elseif Redis:get(TheNova.."Nova:Add:Rd:Manager:Audio"..v..ide) then
db = "Audio@"..Redis:get(TheNova.."Nova:Add:Rd:Manager:Audio"..v..ide)
elseif Redis:get(TheNova.."Nova:Add:Rd:Manager:video_note"..v..ide) then
db = "video_note@"..Redis:get(TheNova.."Nova:Add:Rd:Manager:video_note"..v..ide)
end
v = string.gsub(v,'"','')
v = string.gsub(v,"'",'')
...
Redis:sadd(TheNova.."Nova:List:Manager"..GroupId,k)
if v and v:match('gif@(.*)') then
Redis:set(TheNova.."Nova:Add:Rd:Manager:Gif"..k..GroupId,v:match('gif@(.*)'))
elseif v and v:match('Vico@(.*)') then
Redis:set(TheNova.."Nova:Add:Rd:Manager:Vico"..k..GroupId,v:match('Vico@(.*)'))
elseif v and v:match('Stekrs@(.*)') then
Redis:set(TheNova.."Nova:Add:Rd:Manager:Stekrs"..k..GroupId,v:match('Stekrs@(.*)'))
elseif v and v:match('Text@(.*)') then
Redis:set(TheNova.."Nova:Add:Rd:Manager:Text"..k..GroupId,v:match('Text@(.*)'))
elseif v and v:match('Photo@(.*)') then
Redis:set(TheNova.."Nova:Add:Rd:Manager:Photo"..k..GroupId,v:match('Photo@(.*)'))
elseif v and v:match('Video@(.*)') then
Redis:set(TheNova.."Nova:Add:Rd:Manager:Video"..k..GroupId,v:match('Video@(.*)'))
elseif v and v:match('File@(.*)') then
Redis:set(TheNova.."Nova:Add:Rd:Manager:File"..k..GroupId,v:match('File@(.*)') )
elseif v and v:match('Audio@(.*)') then
Redis:set(TheNova.."Nova:Add:Rd:Manager:Audio"..k..GroupId,v:match('Audio@(.*)'))
elseif v and v:match('video_note@(.*)') then
Redis:set(TheNova.."Nova:Add:Rd:Manager:video_note"..k..GroupId,v:match('video_note@(.*)') )
end
end
end
end
...
Redis:set(TheNova..'Nova:Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
local photo = LuaTele.getUserProfilePhotos(TheNova)
local mrt = LuaTele.getUser(TheNova)
for Name_User in string.gmatch(mrt.first_name, "[^%s]+" ) do
mrt.first_name = Name_User
break
end 
Groups = (Redis:scard(TheNova..'Nova:ChekBotAdd') or 0)
Users = (Redis:scard(TheNova..'Nova:Num:User:Pv') or 0)
if photo.total_count > 0 then
local novaa = 'احصائيات الـــبوت'
...
{
{text = Grosupsw, url = 'https://t.me/K_I_U1'}, 
},
{
{text = Usperos, url = 'https://t.me/K_I_U1'}, 
},
}
msgg = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id.."&photo=".. URL.escape(novaa).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
...
if Redis:sismember(TheNova.."Nova:ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(TheNova..'Nova:Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,'◍ عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(TheNova..'Nova:Num:Add:Bot'),"md",true)  
end
...
Redis:sadd(TheNova.."Nova:ChekBotAdd",msg_chat_id)
Redis:set(TheNova.."Nova:Status:Id"..msg_chat_id,true) ;Redis:set(TheNova.."Nova:Status:Reply"..msg_chat_id,true) ;Redis:set(TheNova.."Nova:Status:ReplySudo"..msg_chat_id,true) ;Redis:set(TheNova.."Nova:Status:BanId"..msg_chat_id,true) ;Redis:set(TheNova.."Nova:Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(TheNova.."Nova:BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(TheNova.."Nova:ChekBotAdd",msg_chat_id) then
...
Redis:srem(TheNova.."Nova:ChekBotAdd",msg_chat_id)
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(TheNova.."Nova:ChekBotAdd",msg_chat_id) then
Redis:incr(TheNova..'Nova:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
if text == "ايدي" and msg.reply_to_message_id == 0 then
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(TheNova..'Nova:Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n◍ عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end 
if not Redis:get(TheNova.."Nova:Status:Id"..msg_chat_id) then
return false
end
local UserInfo = LuaTele.getUser(msg.sender.user_id)
...
local TotalMsg = Redis:get(TheNova..'Nova:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(TheNova..'Nova:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(TheNova.."Nova:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(TheNova.."Nova:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
...
Get_Is_Id = Redis:get(TheNova.."Nova:Set:Id:Group"..msg_chat_id)
if Redis:get(TheNova.."Nova:Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
local TotalMsg = Redis:get(TheNova..'Nova:Num:Message:User'..msg_chat_id..':'..Message_Reply.sender.user_id) or 0
local TotalEdit = Redis:get(TheNova..'Nova:Num:Message:Edit'..msg_chat_id..Message_Reply.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*◍ ايديه : '..UserId..
...
local TotalMsg = Redis:get(TheNova..'Nova:Num:Message:User'..msg_chat_id..':'..UserId_Info.id) or 0
local TotalEdit = Redis:get(TheNova..'Nova:Num:Message:Edit'..msg_chat_id..UserId_Info.id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*⌔︙ايديه : '..UserId..
'\n⌔︙معرفه : @'..UserName..
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,TheNova).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,'◍ البوت عضو في المجموعه ',"md",true) 
end
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,TheNova).status
if GetMemberStatus.can_change_info then
change_info = '❬ ✔️ ❭' else change_info = '❬ ❌ ❭'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(TheNova.."Nova:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◍ تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(TheNova.."Nova:DevelopersQ:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheNova.."Nova:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◍ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TheNova.."Nova:Developers:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheNova.."Nova:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◍ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(TheNova.."Nova:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheNova.."Nova:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◍ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheNova.."Nova:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheNova.."Nova:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◍ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(TheNova.."Nova:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheNova.."Nova:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◍ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheNova.."Nova:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheNova.."Nova:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◍ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheNova.."Nova:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheNova.."Nova:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TheNova.."Nova:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheNova.."Nova:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TheNova.."Nova:Developers:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheNova.."Nova:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheNova.."Nova:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheNova.."Nova:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheNova.."Nova:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheNova.."Nova:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheNova.."Nova:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheNova.."Nova:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheNova.."Nova:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheNova.."Nova:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheNova.."Nova:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheNova.."Nova:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"◍ تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(TheNova.."Nova:DevelopersQ:Groups",UserId) 
...
if not Redis:sismember(TheNova.."Nova:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"◍ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TheNova.."Nova:Developers:Groups",UserId) 
...
if not Redis:sismember(TheNova.."Nova:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◍ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(TheNova.."Nova:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheNova.."Nova:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◍ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheNova.."Nova:Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheNova.."Nova:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◍ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(TheNova.."Nova:Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheNova.."Nova:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◍ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheNova.."Nova:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheNova.."Nova:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◍ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheNova.."Nova:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheNova.."Nova:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◍ تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheNova.."Nova:DevelopersQ:Groups",UserId_Info.id) 
...
if Redis:sismember(TheNova.."Nova:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◍ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheNova.."Nova:Developers:Groups",UserId_Info.id) 
...
if Redis:sismember(TheNova.."Nova:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◍ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheNova.."Nova:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheNova.."Nova:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◍ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheNova.."Nova:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheNova.."Nova:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◍ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheNova.."Nova:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not msg.Originators and not Redis:get(TheNova.."Nova:Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(TheNova.."Nova:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◍ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheNova.."Nova:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheNova.."Nova:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◍ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheNova.."Nova:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheNova.."Nova:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TheNova.."Nova:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheNova.."Nova:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheNova.."Nova:Developers:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheNova.."Nova:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheNova.."Nova:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheNova.."Nova:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheNova.."Nova:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheNova.."Nova:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheNova.."Nova:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheNova.."Nova:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheNova.."Nova:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheNova.."Nova:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheNova.."Nova:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheNova.."Nova:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"◍ تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheNova.."Nova:DevelopersQ:Groups",UserId) 
...
if Redis:sismember(TheNova.."Nova:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"◍ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheNova.."Nova:Developers:Groups",UserId) 
...
if Redis:sismember(TheNova.."Nova:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◍ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheNova.."Nova:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheNova.."Nova:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◍ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheNova.."Nova:Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheNova.."Nova:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◍ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheNova.."Nova:Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheNova.."Nova:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◍ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheNova.."Nova:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheNova.."Nova:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◍ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheNova.."Nova:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(TheNova.."Nova:Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(TheNova.."Nova:President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TheNova.."Nova:Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TheNova.."Nova:Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(TheNova.."Nova:Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TheNova.."Nova:Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(TheNova.."Nova:DevelopersQ:Groups") 
...
local Info_Members = Redis:smembers(TheNova.."Nova:Developers:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"◍ لا يوجد مطورين حاليا , ","md",true)  
end
ListMembers = '\n*◍ قائمه مطورين البوت \n — — — — — — — — —*\n'
...
local Info_Members = Redis:smembers(TheNova.."Nova:TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheNova.."Nova:Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheNova.."Nova:Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheNova.."Nova:Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheNova.."Nova:Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheNova.."Nova:BanAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheNova.."Nova:BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheNova.."Nova:SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(TheNova.."Nova:Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم تفعيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(TheNova.."Nova:Status:Welcome"..msg_chat_id,true) 
...
Redis:set(TheNova.."Nova:Status:Id"..msg_chat_id,true) 
...
Redis:set(TheNova.."Nova:Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(TheNova.."Nova:Status:Reply"..msg_chat_id,true) 
...
Redis:set(TheNova.."Nova:Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(TheNova.."Nova:Status:BanId"..msg_chat_id,true) 
...
Redis:set(TheNova.."Nova:BotFree",true) 
...
Redis:set(TheNova.."Nova:TwaslBot",true) 
...
if text and text:match("^(.*)$") then
if Redis:get(TheNova.."Nova1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(TheNova.."Nova1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(TheNova.."Nova1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(TheNova.."Nova1:List:Rd:Sudo"..msg.chat_id, text)
return  LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(TheNova.."Nova1:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:del(TheNova..'Nova1:Add:Rd:Sudo:Text'..text..msg.chat_id)
Redis:del(TheNova..'Nova1:Add:Rd:Sudo:Text1'..text..msg.chat_id)
Redis:del(TheNova..'Nova1:Add:Rd:Sudo:Text2'..text..msg.chat_id)
Redis:del(TheNova.."Nova1:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(TheNova.."Nova1:List:Rd:Sudo"..msg.chat_id, text)
...
local list = Redis:smembers(TheNova.."Nova1:List:Rd:Sudo"..msg.chat_id)
for k,v in pairs(list) do  
Redis:del(TheNova.."Nova1:Add:Rd:Sudo:Text"..v..msg.chat_id) 
Redis:del(TheNova.."Nova1:Add:Rd:Sudo:Text1"..v..msg.chat_id) 
Redis:del(TheNova.."Nova1:Add:Rd:Sudo:Text2"..v..msg.chat_id) 
Redis:del(TheNova.."Nova1:List:Rd:Sudo"..msg.chat_id)
end
...
Redis:set(TheNova.."Nova1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(TheNova.."Nova1:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(TheNova.."Nova1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheNova.."Nova1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(TheNova.."Nova1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheNova.."Nova1:Add:Rd:Sudo:Text"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(TheNova.."Nova1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheNova.."Nova1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(TheNova.."Nova1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheNova.."Nova1:Add:Rd:Sudo:Text1"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(TheNova.."Nova1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheNova.."Nova1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(TheNova.."Nova1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheNova.."Nova1:Add:Rd:Sudo:Text2"..test..msg.chat_id, text)  
end  
...
if text then
local Text = Redis:get(TheNova.."Nova1:Add:Rd:Sudo:Text"..text..msg.chat_id)   
local Text1 = Redis:get(TheNova.."Nova1:Add:Rd:Sudo:Text1"..text..msg.chat_id)   
local Text2 = Redis:get(TheNova.."Nova1:Add:Rd:Sudo:Text2"..text..msg.chat_id)   
...
if text and text:match("^(.*)$") then
if Redis:get(TheNova.."Nova11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ')
Redis:set(TheNova.."Nova11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(TheNova.."Nova11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(TheNova.."Nova11:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if Redis:get(TheNova.."Nova11:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف الرد من ردود المتعدده")
Redis:del(TheNova..'Nova11:Add:Rd:Sudo:Text'..text)
Redis:del(TheNova..'Nova11:Add:Rd:Sudo:Text1'..text)
Redis:del(TheNova..'Nova11:Add:Rd:Sudo:Text2'..text)
Redis:del(TheNova.."Nova11:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(TheNova.."Nova11:List:Rd:Sudo", text)
return false
end
end
...
local list = Redis:smembers(TheNova.."Nova11:List:Rd:Sudo")
for k,v in pairs(list) do  
Redis:del(TheNova.."Nova11:Add:Rd:Sudo:Text"..v) 
Redis:del(TheNova.."Nova11:Add:Rd:Sudo:Text1"..v) 
Redis:del(TheNova.."Nova11:Add:Rd:Sudo:Text2"..v)   
Redis:del(TheNova.."Nova11:List:Rd:Sudo")
end
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف ردود المتعدده")
end
...
Redis:set(TheNova.."Nova11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الرد الذي اريد اضافته")
end
...
Redis:set(TheNova.."Nova11:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(TheNova.."Nova11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheNova.."Nova11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(TheNova.."Nova11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheNova.."Nova11:Add:Rd:Sudo:Text"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
...
if text then  
local test = Redis:get(TheNova.."Nova11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheNova.."Nova11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(TheNova.."Nova11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheNova.."Nova11:Add:Rd:Sudo:Text1"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
...
if text then  
local test = Redis:get(TheNova.."Nova11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheNova.."Nova11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(TheNova.."Nova11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheNova.."Nova11:Add:Rd:Sudo:Text2"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد")
return false  
end  
...
if text then
local Text = Redis:get(TheNova.."Nova11:Add:Rd:Sudo:Text"..text)   
local Text1 = Redis:get(TheNova.."Nova11:Add:Rd:Sudo:Text1"..text)   
local Text2 = Redis:get(TheNova.."Nova11:Add:Rd:Sudo:Text2"..text)   
if Text or Text1 or Text2 then 
local texting = {
Text,
Text1,
...
Redis:sadd(TheNova.."Nova:allM"..msg.chat_id, msg.id)
if Redis:get(TheNova.."Nova:Status:Del:Media"..msg.chat_id) then    
local gmedia = Redis:scard(TheNova.."Nova:allM"..msg.chat_id)  
if gmedia >= 200 then
local liste = Redis:smembers(TheNova.."Nova:allM"..msg.chat_id)
...
Redis:del(TheNova.."Nova:allM"..msg.chat_id)
end
end
end
...
local list = Redis:smembers(TheNova.."Nova:allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(TheNova.."Nova:allM"..msg.chat_id)  
...
Redis:del(TheNova.."Nova:Status:Del:Media"..msg.chat_id)
...
Redis:set(TheNova.."Nova:Status:Del:Media"..msg.chat_id,true)
...
Redis:del(TheNova.."Nova:Status:yt"..msg.chat_id)
...
Redis:set(TheNova.."Nova:Status:yt"..msg.chat_id,true)
LuaTele.sendText(msg_chat_id,msg_id,'◍ تم تفعيل اليوتيوب')
return false
end 
if text and text:match('^بحث (.*)$') and Redis:get(TheNova.."Nova:Status:yt"..msg.chat_id) then
...
if TextMsg == 'الرابط' then
Redis:del(TheNova.."Nova:Status:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم تعطيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(TheNova.."Nova:Status:Welcome"..msg_chat_id) 
...
Redis:del(TheNova.."Nova:Status:Id"..msg_chat_id) 
...
Redis:del(TheNova.."Nova:Status:IdPhoto"..msg_chat_id) 
...
Redis:del(TheNova.."Nova:Status:Reply"..msg_chat_id) 
...
Redis:del(TheNova.."Nova:Status:ReplySudo"..msg_chat_id) 
...
Redis:del(TheNova.."Nova:Status:BanId"..msg_chat_id) 
...
Redis:del(TheNova.."Nova:Status:SetId"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم تعطيل الرفع ","md",true)
end
if TextMsg == 'الالعاب' then
Redis:del(TheNova.."Nova:Status:Games"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم تعطيل الالعاب ","md",true)
end
if TextMsg == 'اطردني' then
Redis:del(TheNova.."Nova:Status:KickMe"..msg_chat_id) 
...
Redis:del(TheNova.."Nova:BotFree") 
...
Redis:del(TheNova.."Nova:TwaslBot") 
...
if Redis:sismember(TheNova.."Nova:BanAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◍ تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheNova.."Nova:BanAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheNova.."Nova:BanAll:Groups",UserId_Info.id) then
...
Redis:srem(TheNova.."Nova:BanAll:Groups",UserId_Info.id) 
...
if not msg.Originators and not Redis:get(TheNova.."Nova:Status:BanId"..msg_chat_id) then
...
if Redis:sismember(TheNova.."Nova:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◍ تم حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheNova.."Nova:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
...
if not Redis:sismember(TheNova.."Nova:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◍ تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheNova.."Nova:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TheNova.."Nova:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◍ تم كتمه في المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheNova.."Nova:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheNova.."Nova:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◍ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(TheNova.."Nova:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◍ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(TheNova.."Nova:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TheNova.."Nova:BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheNova.."Nova:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TheNova.."Nova:BanAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheNova.."Nova:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheNova.."Nova:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(TheNova.."Nova:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheNova.."Nova:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TheNova.."Nova:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheNova.."Nova:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheNova.."Nova:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheNova.."Nova:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(TheNova.."Nova:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"◍ تم حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheNova.."Nova:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
...
if not Redis:sismember(TheNova.."Nova:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"◍ تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheNova.."Nova:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TheNova.."Nova:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"◍ تم كتمه في المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheNova.."Nova:SilentGroup:Group"..msg_chat_id,UserId) 
...
if not Redis:sismember(TheNova.."Nova:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"◍ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(TheNova.."Nova:SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"◍ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if not Redis:get(TheNova.."Nova:Status:KickMe"..msg_chat_id) then
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(TheNova.."Nova:TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(TheNova.."Nova:Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
Redis:set(TheNova.."Nova:Lock:text"..msg_chat_id,true) 
...
Redis:set(TheNova.."Nova:Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(TheNova.."Nova:Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(TheNova.."Nova:Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(TheNova.."Nova:Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(TheNova.."Nova:Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(TheNova.."Nova:lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(TheNova.."Nova:Lock:edit"..msg_chat_id,true) 
...
Redis:set(TheNova.."Nova:Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(TheNova..'Nova:'..lock..msg_chat_id,"del")    
end
...
Redis:del(TheNova.."Nova:Lock:AddMempar"..msg_chat_id)  
...
Redis:del(TheNova.."Nova:Lock:text"..msg_chat_id)  
...
Redis:del(TheNova.."Nova:Lock:Join"..msg_chat_id)  
...
Redis:del(TheNova.."Nova:Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(TheNova.."Nova:Lock:tagservr"..msg_chat_id)  
...
Redis:del(TheNova.."Nova:lockpin"..msg_chat_id)  
...
Redis:del(TheNova.."Nova:Lock:edit"..msg_chat_id) 
...
Redis:del(TheNova.."Nova:Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(TheNova..'Nova:'..lock..msg_chat_id)    
end
...
Redis:hset(TheNova.."Nova:Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(TheNova.."Nova:Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(TheNova.."Nova:Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(TheNova.."Nova:Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(TheNova.."Nova:Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(TheNova.."Nova:Lock:Link"..msg_chat_id,"del")  
...
Redis:set(TheNova.."Nova:Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(TheNova.."Nova:Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(TheNova.."Nova:Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(TheNova.."Nova:Lock:Link"..msg_chat_id)  
...
Redis:set(TheNova.."Nova:Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(TheNova.."Nova:Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(TheNova.."Nova:Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(TheNova.."Nova:Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(TheNova.."Nova:Lock:User:Name"..msg_chat_id)  
...
Redis:set(TheNova.."Nova:Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(TheNova.."Nova:Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(TheNova.."Nova:Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(TheNova.."Nova:Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(TheNova.."Nova:Lock:hashtak"..msg_chat_id)  
...
Redis:set(TheNova.."Nova:Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(TheNova.."Nova:Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(TheNova.."Nova:Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(TheNova.."Nova:Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:del(TheNova.."Nova:Lock:Cmd"..msg_chat_id)  
...
Redis:set(TheNova.."Nova:Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(TheNova.."Nova:Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(TheNova.."Nova:Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(TheNova.."Nova:Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(TheNova.."Nova:Lock:Photo"..msg_chat_id)  
...
Redis:set(TheNova.."Nova:Lock:Video"..msg_chat_id,"del")  
...
Redis:set(TheNova.."Nova:Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(TheNova.."Nova:Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(TheNova.."Nova:Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(TheNova.."Nova:Lock:Video"..msg_chat_id)  
...
Redis:set(TheNova.."Nova:Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(TheNova.."Nova:Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(TheNova.."Nova:Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(TheNova.."Nova:Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(TheNova.."Nova:Lock:Animation"..msg_chat_id)  
...
Redis:set(TheNova.."Nova:Lock:geam"..msg_chat_id,"del")  
...
Redis:set(TheNova.."Nova:Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(TheNova.."Nova:Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(TheNova.."Nova:Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(TheNova.."Nova:Lock:geam"..msg_chat_id)  
...
Redis:set(TheNova.."Nova:Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(TheNova.."Nova:Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(TheNova.."Nova:Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(TheNova.."Nova:Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(TheNova.."Nova:Lock:Audio"..msg_chat_id)  
...
Redis:set(TheNova.."Nova:Lock:vico"..msg_chat_id,"del")  
...
Redis:set(TheNova.."Nova:Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(TheNova.."Nova:Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(TheNova.."Nova:Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(TheNova.."Nova:Lock:vico"..msg_chat_id)  
...
Redis:set(TheNova.."Nova:Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(TheNova.."Nova:Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(TheNova.."Nova:Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(TheNova.."Nova:Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(TheNova.."Nova:Lock:Keyboard"..msg_chat_id)  
...
Redis:set(TheNova.."Nova:Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(TheNova.."Nova:Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(TheNova.."Nova:Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(TheNova.."Nova:Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(TheNova.."Nova:Lock:Sticker"..msg_chat_id)  
...
Redis:set(TheNova.."Nova:Lock:forward"..msg_chat_id,"del")  
...
Redis:set(TheNova.."Nova:Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(TheNova.."Nova:Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(TheNova.."Nova:Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(TheNova.."Nova:Lock:forward"..msg_chat_id)  
...
Redis:set(TheNova.."Nova:Lock:Document"..msg_chat_id,"del")  
...
Redis:set(TheNova.."Nova:Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(TheNova.."Nova:Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(TheNova.."Nova:Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(TheNova.."Nova:Lock:Document"..msg_chat_id)  
...
Redis:set(TheNova.."Nova:Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(TheNova.."Nova:Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(TheNova.."Nova:Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(TheNova.."Nova:Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(TheNova.."Nova:Lock:Unsupported"..msg_chat_id)  
...
Redis:set(TheNova.."Nova:Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(TheNova.."Nova:Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(TheNova.."Nova:Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(TheNova.."Nova:Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(TheNova.."Nova:Lock:Markdaun"..msg_chat_id)  
...
Redis:set(TheNova.."Nova:Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(TheNova.."Nova:Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(TheNova.."Nova:Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(TheNova.."Nova:Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(TheNova.."Nova:Lock:Contact"..msg_chat_id)  
...
Redis:set(TheNova.."Nova:Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(TheNova.."Nova:Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(TheNova.."Nova:Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(TheNova.."Nova:Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(TheNova.."Nova:Lock:Spam"..msg_chat_id)  
...
Redis:set(TheNova.."Nova:Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(TheNova.."Nova:Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(TheNova.."Nova:Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(TheNova.."Nova:Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(TheNova.."Nova:Lock:Inlen"..msg_chat_id)  
...
Redis:setex(TheNova.."Nova:Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:del(TheNova.."Nova:Group:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم مسح الرابط ","md",true)             
end
if text == "الرابط" then
if not Redis:get(TheNova.."Nova:Status:Link"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم تعطيل جلب الرابط من قبل الادمنيه","md",true)
end 
local Get_Chat = LuaTele.getChat(msg_chat_id)
local GetLink = Redis:get(TheNova.."Nova:Group:Link"..msg_chat_id) 
if GetLink then
...
Redis:setex(TheNova.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(TheNova.."Nova:Status:Welcome"..msg_chat_id) then
...
Redis:del(TheNova.."Nova:Welcome:Group"..msg_chat_id) 
...
Redis:setex(TheNova.."Nova:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(TheNova.."Nova:Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم ازالة قوانين المجموعه","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(TheNova.."Nova:Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(TheNova.."Nova:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(TheNova.."Nova:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(TheNova.."Nova:List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(TheNova.."Nova:Filter:Group:"..v..msg_chat_id)  
Redis:srem(TheNova.."Nova:List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(TheNova.."Nova:Filter:Group:"..v..msg_chat_id)   
...
Redis:set(TheNova..'Nova:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(TheNova..'Nova:FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n*◍ ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
...
Redis:set(TheNova.."Nova:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(TheNova.."Nova:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(TheNova.."Nova:Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(TheNova.."Nova:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(TheNova.."Nova:Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(TheNova.."Nova:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
...
if Redis:get(TheNova.."Nova:Status:Link"..msg.chat_id) then
Statuslink = '❬ ✔️ ❭' else Statuslink = '❬ ❌ ❭'
end
if Redis:get(TheNova.."Nova:Status:Welcome"..msg.chat_id) then
StatusWelcome = '❬ ✔️ ❭' else StatusWelcome = '❬ ❌ ❭'
end
if Redis:get(TheNova.."Nova:Status:Id"..msg.chat_id) then
StatusId = '❬ ✔️ ❭' else StatusId = '❬ ❌ ❭'
end
if Redis:get(TheNova.."Nova:Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '❬ ✔️ ❭' else StatusIdPhoto = '❬ ❌ ❭'
end
if Redis:get(TheNova.."Nova:Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✔️ ❭' else StatusReply = '❬ ❌ ❭'
end
if Redis:get(TheNova.."Nova:Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '❬ ✔️ ❭' else StatusReplySudo = '❬ ❌ ❭'
end
if Redis:get(TheNova.."Nova:Status:BanId"..msg.chat_id)  then
StatusBanId = '❬ ✔️ ❭' else StatusBanId = '❬ ❌ ❭'
end
if Redis:get(TheNova.."Nova:Status:SetId"..msg.chat_id) then
StatusSetId = '❬ ✔️ ❭' else StatusSetId = '❬ ❌ ❭'
end
if Redis:get(TheNova.."Nova:Status:Games"..msg.chat_id) then
StatusGames = '❬ ✔️ ❭' else StatusGames = '❬ ❌ ❭'
end
if Redis:get(TheNova.."Nova:Status:KickMe"..msg.chat_id) then
Statuskickme = '❬ ✔️ ❭' else Statuskickme = '❬ ❌ ❭'
end
if Redis:get(TheNova.."Nova:Status:AddMe"..msg.chat_id) then
...
data = {
{
{text = '‹SOURCE JACK ›', url = 't.me/K_I_U1'}, 
},
}
}
...
Rink = 1
elseif Redis:sismember(TheNova.."Nova:Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(TheNova.."Nova:TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 3
elseif Redis:sismember(TheNova.."Nova:Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(TheNova.."Nova:Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(TheNova.."Nova:Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(TheNova.."Nova:Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
else
Rink = 8
end
...
Rink = 1
elseif Redis:sismember(TheNova.."Nova:Developers:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(TheNova.."Nova:TheBasics:Group"..msg_chat_id, UserId_Info.id) then
Rink = 3
elseif Redis:sismember(TheNova.."Nova:Originators:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(TheNova.."Nova:Managers:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(TheNova.."Nova:Addictive:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(TheNova.."Nova:Distinguished:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
else
Rink = 8
end
...
Redis:del(TheNova..'Nova:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'◍ تم مسح جميع رسائلك ',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(TheNova..'Nova:Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'◍ تم مسح جميع تعديلاتك ',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(TheNova..'Nova:Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'◍ تم مسح جميع جهاتك المضافه ',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'◍ عدد رسائلك هنا *~ '..(Redis:get(TheNova..'Nova:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'◍ عدد التعديلات هنا *~ '..(Redis:get(TheNova..'Nova:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'◍ عدد جهاتك المضافه هنا *~ '..(Redis:get(TheNova.."Nova:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:setex(TheNova.."Nova:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
◍ ارسل الان النص
◍ يمكنك اضافه :
...
Redis:del(TheNova.."Nova:Set:Id:Group"..msg.chat_id)
...
Redis:del(TheNova.."Nova:DevelopersQ:Groups") 
...
Redis:del(TheNova.."Nova:Developers:Groups") 
...
Redis:del(TheNova.."Nova:TheBasics:Group"..msg_chat_id) 
...
Redis:del(TheNova.."Nova:Originators:Group"..msg_chat_id) 
...
Redis:del(TheNova.."Nova:Managers:Group"..msg_chat_id) 
...
Redis:del(TheNova.."Nova:Addictive:Group"..msg_chat_id) 
...
Redis:del(TheNova.."Nova:Distinguished:Group"..msg_chat_id) 
...
Redis:del(TheNova.."Nova:BanAll:Groups") 
...
Redis:del(TheNova.."Nova:BanGroup:Group"..msg_chat_id) 
...
Redis:del(TheNova.."Nova:SilentGroup:Group"..msg_chat_id) 
...
local list = Redis:smembers(TheNova.."Nova:List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(TheNova.."Nova:Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(TheNova.."Nova:Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(TheNova.."Nova:Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(TheNova.."Nova:Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(TheNova.."Nova:Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(TheNova.."Nova:Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(TheNova.."Nova:Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(TheNova.."Nova:Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(TheNova.."Nova:Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(TheNova.."Nova:List:Manager"..msg_chat_id)
end
...
for k,v in pairs(list) do
if Redis:get(TheNova.."Nova:Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(TheNova.."Nova:Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(TheNova.."Nova:Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(TheNova.."Nova:Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(TheNova.."Nova:Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(TheNova.."Nova:Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(TheNova.."Nova:Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف ⌔"
elseif Redis:get(TheNova.."Nova:Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(TheNova.."Nova:Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(TheNova.."Nova:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(TheNova.."Nova:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
...
local list = Redis:smembers(TheNova.."Nova:List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(TheNova.."Nova:Add:Rd:Sudo:Gif"..v)   
Redis:del(TheNova.."Nova:Add:Rd:Sudo:vico"..v)   
Redis:del(TheNova.."Nova:Add:Rd:Sudo:stekr"..v)     
Redis:del(TheNova.."Nova:Add:Rd:Sudo:Text"..v)   
Redis:del(TheNova.."Nova:Add:Rd:Sudo:Photo"..v)
Redis:del(TheNova.."Nova:Add:Rd:Sudo:Video"..v)
Redis:del(TheNova.."Nova:Add:Rd:Sudo:File"..v)
Redis:del(TheNova.."Nova:Add:Rd:Sudo:Audio"..v)
Redis:del(TheNova.."Nova:Add:Rd:Sudo:video_note"..v)
Redis:del(TheNova.."Nova:List:Rd:Sudo")
end
...
text = "\n📝︙قائمة ردود المطور \n— — — — — — — — —\n"
for k,v in pairs(list) do
if Redis:get(TheNova.."Nova:Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(TheNova.."Nova:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(TheNova.."Nova:Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(TheNova.."Nova:Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(TheNova.."Nova:Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(TheNova.."Nova:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(TheNova.."Nova:Add:Rd:Sudo:File"..v) then
db = "ملف ⌔"
elseif Redis:get(TheNova.."Nova:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(TheNova.."Nova:Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(TheNova.."Nova:Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(TheNova.."Nova:Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:setex(TheNova.."Nova:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(TheNova.."Nova:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(TheNova.."Nova:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(TheNova.."Nova:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(TheNova.."Nova:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(TheNova..'Nova:GetTexting:DevTheNova'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(TheNova..'Nova:Texting:DevTheNova')
return LuaTele.sendText(msg_chat_id,msg_id,'◍  تم حذف كليشه المطور')
end
if text == 'المطور' or text == 'مطور' then
local TextingDevTheNova = Redis:get(TheNova..'Nova:Texting:DevTheNova')
if TextingDevTheNova then 
return LuaTele.sendText(msg_chat_id,msg_id,TextingDevTheNova,"md",true)  
else
...
{
{text = '‹SOURCE JACK ›', url = "https://t.me/K_I_U1"}
},
}
...
keyboard.inline_keyboard = {
{
{text = '‹SOURCE JACK ›', url = "https://t.me/جvod_ik_ax"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if text == 'بار شيكو' then
photo = "https://t.me/SH_YC"
local T =[[
W𝑒𝑙𝑐𝑜𝑚𝑒 𝑡𝑜 𝑔𝑟𝑢𝑝𖤐
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '‹ W𝑒𝑙𝑐𝑜𝑚𝑒 𝑡𝑜 𝑔𝑟𝑢𝑝𖤐 ›', url = "https://t.me/JANK3S"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if text == 'مبرمج السورس' or text == 'شيكو' then
photo = "https://t.me/SH_TI_N/109"
local T =[[
 [✭ الـبـعـض یـفـتـخـر بـانـه غـالـی الـثـمـن وانـا افـتـخـر بـانـی لـسـت لـلـبـیـع]
...
keyboard.inline_keyboard = {
{
{text = '‹ Sℎ𝑦𝑐𝑜 ›', url = "https://t.me/SHYCO_BOT"}
},
{
{text = '‹SOURCE JACK ›', url = "https://t.me/vod_ik_ax"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
photo = "https://t.me/SH_TI_N/104"
local T =[[
[✭ السوشيل لعبه وانا اخر ليفل فيها]
...
keyboard.inline_keyboard = {
{
{text = '‹ JACK ›', url = "https://t.me/Jac_kx"}
},
{
{text = '‹SOURCE JACK ›', url = "https://t.me/Vo_dika"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
photo = "https://t.me/SH_TI_N/111"
local T =[[
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
🚨╎𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 

⚙╎𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 𝙾𝙽 𝙴𝙶𝚈𝙿𝚃

⚡╎𝚁𝚄𝙽 𝚈𝙾𝚄𝚁 𝙱𝙾𝚃 𝚆𝙸𝚃𝙷 𝚄𝚂 𝙽𝙾𝚆
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
──┈┈┈┄┄╌╌╌╌┄┄┈┈┈
◍C𝐻 " 𝐽𝐴𝑁𝐾𝐸𝐸𝑆 𝑆𝑂𝐔𝑅𝑆𝐴◍
──┈┈┈┄┄╌╌╌╌┄┄┈┈┈
...
keyboard.inline_keyboard = {
{
{text = '‹ SHYCO ›', url = "https://t.me/SHYCO_BOT"},{text = '‹ JACK ›', url = "https://t.me/Jac_kx"}
},
{
{text = '‹ Mohamed ›', url = "https://t.me/W_Y_R"},{text = '‹ Mohamed ›', url = "https://t.me/K_I_U1"}
}. 
{
{text = '‹SOURCE JACK ›', url = "https://t.me/K_I_U1"}
},
...
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendVideo?chat_id=" .. msg_chat_id .. "&video="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
elseif text == 'م1' then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*◍ هاذا الامر يخص { '..Controller_Num(7)..' }* ',"md",true)  
end
...
{
{text = '‹SOURCE JACK ›', url = 't.me/Nova'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id,'◍ عليك استخدام اوامر التحكم بالقوائم',"md",false, false, false, false, reply_markup)
...
Redis:setex(TheNova.."Nova:Change:Name:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(TheNova.."Nova:Name:Bot") 
...
local NamesBot = (Redis:get(TheNova.."Nova:Name:Bot") or "جانكيز")
local BotName = {
...
if text == (Redis:get(TheNova.."Nova:Name:Bot") or "جانكيز") then
local photo = LuaTele.getUserProfilePhotos(TheNova)
local mrt = LuaTele.getUser(TheNova)
for Name_User in string.gmatch(mrt.first_name, "[^%s]+" ) do
mrt.first_name = Name_User
...
x = x + 1
Redis:srem(TheNova..'Nova:Num:User:Pv',v)
end
end
if x ~= 0 then
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,TheNova)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'*◍ البوت عظو في المجموعه سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
Redis:srem(TheNova..'Nova:ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(TheNova..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(TheNova..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(TheNova..'Nova:ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(TheNova.."Nova:Game:Smile"..msg.chat_id,SM)
...
Redis:set(TheNova.."Nova:Game:Monotonous"..msg.chat_id,name)
...
Redis:set(TheNova.."Nova:Game:Riddles"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(TheNova.."Nova:Status:Games"..msg.chat_id) then
Redis:del(TheNova.."Nova:Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(TheNova.."Nova:Game:Meaningof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(TheNova.."Nova:Status:Games"..msg.chat_id) then
Redis:del(TheNova.."Nova:Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(TheNova.."Nova:Game:Reflection"..msg.chat_id,name)
...
Redis:set(TheNova.."Nova:Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(TheNova.."Nova:Game:Difference"..msg.chat_id,name)
...
Redis:set(TheNova.."Nova:Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(TheNova.."Nova:Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(TheNova.."Nova:Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(TheNova.."Nova:Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(TheNova.."Nova:Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(TheNova.."Nova:Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(TheNova.."Nova:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(TheNova.."Nova:Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(TheNova.."Nova:Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(TheNova.."Nova:Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(TheNova.."Nova:Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(TheNova.."Nova:Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(TheNova.."Nova:Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(TheNova.."Nova:Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(TheNova.."Nova:Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(TheNova.."Nova:Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:set(TheNova.."Nova:Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(TheNova.."Nova:Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(TheNova.."Nova:Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','ردود المدير')
Redis:set(TheNova.."Nova:Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(TheNova.."Nova:Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(TheNova.."Nova:Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(TheNova.."Nova:Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(TheNova.."Nova:Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:set(TheNova.."Nova:Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
...
if text == '' then
Redis:sadd(TheNova..'Nova:Num:User:Pv',msg.sender.user_id)  
if not msg.ControllerBot then
if not Redis:get(TheNova.."Nova:Start:Bot") then
local CmdStart = '*\n┄─━━SOURCE JACK ━━─┄'..(Redis:get(TheNova.."Nova:Name:Bot") or "جانكيز")..
'\n𖥔 أهلآ بك في بوت'..
'\n𖥔 اختصاص البوت حماية المجموعات'..
'\n𖥔 لتفعيل البوت عليك اتباع مايلي ...'..
'\n𖥔 اضف البوت الى مجموعتك'..
'\n𖥔 ارفعه ادمن {مشرف}'..
'\n𖥔 ارسل كلمة { تفعيل } ليتم تفعيل المجموعه'..
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(TheNova.."Nova:Start:Bot"),"md",false, false, false, false, reply_markup)
end
else
...
Redis:setex(TheNova.."Nova:Change:Start:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(TheNova.."Nova:Start:Bot") 
...
if not msg.ControllerBot then
if Redis:get(TheNova.."Nova:TwaslBot") and not Redis:sismember(TheNova.."Nova:BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(TheNova.."Nova:Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(TheNova.."Nova:Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(TheNova..'Nova:BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,'◍ تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(TheNova..'Nova:BaN:In:Tuasl',Info_User)  
...
Redis:srem(TheNova.."Nova:ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(TheNova..'*'..'-100'..data.supergroup.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(TheNova.."Nova:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheNova.."Nova:PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(TheNova.."Nova:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheNova.."Nova:PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(TheNova.."Nova:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheNova.."Nova:PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(TheNova.."Nova:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheNova.."Nova:PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(TheNova.."Nova:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheNova.."Nova:PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(TheNova.."Nova:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheNova.."Nova:PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(TheNova.."Nova:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheNova.."Nova:PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(TheNova.."Nova:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheNova.."Nova:PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(TheNova.."Nova:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheNova.."Nova:PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(TheNova.."Nova:Lock:tagservr"..data.message.chat_id) then
...
if Message_Edit.sender.user_id == TheNova then
print('This is Edit for Bot')
return false
end
File_Bot_Run(Message_Edit,Message_Edit)
Redis:incr(TheNova..'Nova:Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(TheNova.."Nova:Lock:edit"..data.chat_id) then
...
Redis:incrby(TheNova.."Nova:Num:Add:Games"..ChatId..IdUser, 1)  
...
◍ ارسل ما تريد تحميله
*]]
Redis:set(TheNova.."youtube"..IdUser..ChatId,'mp3')
...
◍ ارسل ما تريد تحميله
*]]
Redis:set(TheNova.."youtube"..IdUser..ChatId,'mp4')
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
end
...
{
{text = '‹ SOURCE JACK ›', url = 't.me/vod_ik_ax'}, 
},
}
}
local TextHelp = [[*
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheNova.."Nova:Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheNova.."Nova:Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheNova.."Nova:Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheNova.."Nova:Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNova.."Nova:Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNova.."Nova:Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNova.."Nova:Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNova.."Nova:Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNova.."Nova:Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNova.."Nova:Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNova.."Nova:Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNova.."Nova:Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNova.."Nova:Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNova.."Nova:Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheNova.."Nova:Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(TheNova.."Nova:TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(TheNova.."Nova:Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(TheNova.."Nova:Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(TheNova..'Nova:'..lock..UserId[2],"del")    
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNova.."Nova:Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNova.."Nova:Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNova.."Nova:Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNova.."Nova:Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNova.."Nova:Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNova.."Nova:Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNova.."Nova:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNova.."Nova:Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNova.."Nova:Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNova.."Nova:Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNova.."Nova:Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNova.."Nova:Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNova.."Nova:Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNova.."Nova:Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNova.."Nova:Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNova.."Nova:Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNova.."Nova:Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNova.."Nova:Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNova.."Nova:Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNova.."Nova:lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNova.."Nova:Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNova.."Nova:Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNova.."Nova:Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNova.."Nova:Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(TheNova.."Nova:Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNova.."Nova:TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNova.."Nova:Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNova.."Nova:Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNova.."Nova:Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNova.."Nova:Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNova.."Nova:BanGroup:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"◍ تم مسح المحظورين", 'md', false)
end
elseif Text and Text:match('(%d+)/SilentGroupGroup') then
local UserId = Text:match('(%d+)/SilentGroupGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheNova.."Nova:SilentGroup:Group"..ChatId) 
